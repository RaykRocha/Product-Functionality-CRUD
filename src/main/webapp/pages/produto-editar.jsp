			...
			<div class="col-lg-12">
				<div class="well">
					...
					<form action="${contextPath}/produto/update" method="post">
						...
						<div class="form-group">
							<label class="control-label" for="nome">SKU:</label> <input
								type="text" name="sku" id="sku" value="${produto.sku}"
								class="form-control" maxlength="50" size="50" />
						</div>
						...
						<div class="form-group">
							...
							<textarea id="descricao" class="form-control" name="descricao"
								rows="4" cols="100">${produto.descricao}</textarea>
						</div>

						<div class="form-group">
							<label class="control-label" for="preco">Preço:</label> <input
								type="numberfi" name="preco" id="preco" value="${produto.preco}"
						...
						<div class="form-group">
							...
							<textarea id="mensagem" class="form-control"
								name="caracteristicas" rows="4" cols="100">${produto.caracteristicas}</textarea>
						</div>
						<hr>
