                ...
                <div class="well">
					...
					<h2>Produto</h2>
						...
						<div class="form-group">
							...
							<b>${produto-detalhe.nome}</b>
                        </div>
                        
                        <div class="form-group">
							<label class="control-label" for="nome">SKU:</label>
							<label class="label label-default">${produto-detalhe.sku}</label>
						</div>
						
						<div class="form-group">
							<label class="control-label" for="mesnagem">Descrição:</label>
							<label class="label label-default">${produto-detalhe.descricao}</label>
						</div>
						
						<div class="form-group">
							<label class="control-label" for="preco">Preço:</label>
							<label class="label label-default">${produto-detalhe.preco}</label>
						</div>
						
						<div class="form-group">
							<label class="control-label" for="mesnagem">Características:</label>
							<label class="label label-default">${produto-detalhe.}</label>
						</div>
						<hr>
